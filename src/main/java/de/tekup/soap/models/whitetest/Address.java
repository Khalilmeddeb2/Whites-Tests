 ...
 *         &lt;element name="code-poste" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Address {
    ...
    @XmlElement(name = "code-poste")
    protected int codePoste;
    ...
    /**
     * Obtient la valeur de la propriété codePoste.
     * 
     */
    ...
    /**
     * Définit la valeur de la propriété codePoste.
     * 
     */
    public void setCodePoste(int value) {
        this.codePoste = value;
    }
